...
from topic_multicore import preprocess_text, stopword, perform_ldamulticore, create_lda_inputs, perform_tsne
...
@app.post("/topic-modeling_multicore/")
async def perform_topic_modeling(data: InputData):
    ...
    lda_model, topics = perform_ldamulticore(doc_term_matrix, total_topics, dictionary, number_words)
    print(topics)
